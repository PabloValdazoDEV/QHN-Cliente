...
export default function Footer() {
  ...
  return (
    // <footer className="bg-[#1e40af] shadow-lg">
    ...
    //         <Link to="/ciudades" className=" text-neutral-700 hover:text-blue-200">
    //           Ciudades
    //         </Link>
    //         <Link to="/categorias" className=" text-neutral-700 hover:text-blue-200">
    //           Categorías
    //         </Link>
    //         <Link to="/sobre-nosotros" className=" text-neutral-700 hover:text-blue-200">
    //           Sobre Nosotros
    //         </Link>
    //         <Link to="/contacto" className=" text-neutral-700 hover:text-blue-200">
    //           Contacto
    //         </Link>
    //       </div>
    ...
    //     <div className="flex flex-col md:flex-row justify-between items-center py-4 border-t border-blue-400">
    //       <p className=" text-neutral-700 text-sm mb-2 md:mb-0">
    //         &copy; <span id="year" className="text-blue-200"></span> Todos los derechos reservados.
    //       </p>
    //       <div className="flex space-x-4">
    //         <Link to="/politica-privacidad" className=" text-neutral-700 hover:text-blue-200 text-sm">
    //           Política de Privacidad
    //         </Link>
    //         <Link to="/terminos" className=" text-neutral-700 hover:text-blue-200 text-sm">
    //           Términos de Uso
    //         </Link>
    //         <Link to="/cookies" className=" text-neutral-700 hover:text-blue-200 text-sm">
    //           Cookies
    //         </Link>
    //       </div>
    //     </div>
    ...
    <footer className="relative bg-white shadow-lg text-neutral-700 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:px-8">
        ...
        <div className="mt-16 pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <Link to="/cookies" className=" text-neutral-700 hover:text-[color:var(--color-primary)] text-sm no-underline hover:underline">
